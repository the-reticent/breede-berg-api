...
router.register(r'planting-events', PlantingEventViewSet, basename='plantingevent')
router.register(r'survival-checks', SurvivalCheckViewSet, basename='survivalcheck')
